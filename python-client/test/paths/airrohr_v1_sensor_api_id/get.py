...
# path params
ApiIDSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'apiID': typing.Union[ApiIDSchema, decimal.Decimal, int, ],
    }
)
...
class GetDataByApiId(BaseApi):
    ...
    def get_data_by_api_id(
        ...
        return self._get_data_by_api_id_oapg(
