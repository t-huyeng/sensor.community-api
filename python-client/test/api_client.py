...
from test.exceptions import ApiTypeError, ApiValueError, ApiException
from test.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = V1Api()
        api_instance.get_data_by_api_id  # this is an instance of the class Endpoint
        api_instance.get_data_by_api_id()  # this invokes api_instance.get_data_by_api_id.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_data_by_api_id.callable or self.callable in this class
